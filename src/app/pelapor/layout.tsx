        ...
        <Dialog open={isLogoutModalOpen} onOpenChange={(open) => !open && setIsLogoutModalOpen(false)}>
          <DialogContent className="max-w-sm rounded-3xl p-8 text-center">
            ...
            <div className="flex items-center gap-3 w-full">
              <Button variant="outline" onClick={() => setIsLogoutModalOpen(false)} className="flex-1 rounded-xl px-4 py-2.5 text-sm">
                Batal
              </Button>
              <Button variant="destructive" onClick={handleLogout} className="flex-1 rounded-xl bg-red-600 px-4 py-2.5 text-sm text-white hover:bg-red-700">
                Log Out
              </Button>
            </div>
          </DialogContent>
